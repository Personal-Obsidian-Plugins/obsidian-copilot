      ...
      <ActiveFileProvider currentActiveFile={currentActiveFile}>
        <div className={cn("tw-relative", className)}>
          <PlainTextPlugin
            contentEditable={
              <ContentEditable
                className="tw-max-h-40 tw-min-h-10 tw-w-full tw-resize-none tw-overflow-y-auto tw-rounded-lg tw-border-none tw-bg-transparent tw-px-3 tw-py-2 tw-text-sm tw-leading-relaxed tw-text-normal tw-outline-none focus-visible:tw-ring-0"
